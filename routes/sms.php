...
$router->register('GENERATE {extra?}', \App\Handlers\SMSGenerate::class);
$router->register('CUT {extra?}', \App\Handlers\SMSCut::class);
$router->register('REDEEM {voucher} {extra?}', \App\Handlers\SMSRedeem::class);
