...
final class ActivateProvisioningRequest extends FormRequest
{
    public function authorize(ProvisioningOperatorAuthority $authority): bool
    {
        ...
        return $operator instanceof Model
            && $authority->allows($operator, ProvisioningOperatorCapability::Activate);
    }
    ...
    {
        return [
            'confirm_identity_and_capabilities' => ['required', 'accepted'],
        ];
    }
}
