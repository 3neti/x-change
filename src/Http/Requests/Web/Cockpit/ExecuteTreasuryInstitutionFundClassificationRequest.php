...
final class ExecuteTreasuryInstitutionFundClassificationRequest extends FormRequest
{
    public function authorize(TreasuryOperatorAuthority $authority): bool
    {
        return $this->user() instanceof Model
            && $authority->allows($this->user(), TreasuryOperatorCapability::ExecuteInstitutionFunds);
    }
