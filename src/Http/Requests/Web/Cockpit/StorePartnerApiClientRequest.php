...
final class StorePartnerApiClientRequest extends FormRequest
{
    public function authorize(PartnerApiOperatorAuthority $authority): bool
    {
        return $this->user() instanceof Model
            && $authority->allows($this->user(), PartnerApiOperatorCapability::ManageSandboxClients);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'acknowledge_secret_once' => ['accepted'],
        ];
    }
}
