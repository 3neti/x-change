...
final class IssueProvisioningOfferRequest extends FormRequest
{
    public function authorize(ProvisioningOperatorAuthority $authority): bool
    {
        ...
        return $operator instanceof Model
            && $authority->allows($operator, ProvisioningOperatorCapability::Issue);
    }

    /** @return array<string, list<mixed>> */
    public function rules(): array
    {
        return ['acknowledge_one_time_link' => ['required', 'accepted']];
    }
}
