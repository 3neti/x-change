...
final class CoreDeploymentEnvironmentContributor implements DeploymentEnvironmentContributor
{
    public function environmentVariables(): array
    {
        return [
            ...
            new EnvironmentVariableData(
                key: 'XCHANGE_PARTNER_API_ENABLED',
                description: 'Activate the governed OAuth Partner API after credentials and mandates are provisioned.',
                category: 'Partner API',
                configPath: 'x-change.partner_api.enabled',
                safeExample: 'false',
            ),
            new EnvironmentVariableData(
                key: 'XCHANGE_PARTNER_API_PUBLIC_DISCOVERY_ENABLED',
                description: 'Publish sanitized OAuth, OpenAPI, and AI discovery without enabling financial operations.',
                category: 'Partner API',
                configPath: 'x-change.partner_api.public_discovery_enabled',
                safeExample: 'true',
            ),
            new EnvironmentVariableData(
                key: 'XCHANGE_PARTNER_API_ACCESS_CONTACT',
                description: 'Public contact address for approved Partner API access requests.',
                category: 'Partner API',
                configPath: 'x-change.partner_api.access_contact',
                safeExample: 'api-access@example.test',
            ),
            new EnvironmentVariableData(
                key: 'PASSPORT_PRIVATE_KEY',
                description: 'OAuth signing private key when deployment storage does not retain oauth-private.key.',
                category: 'Partner API',
                configPath: 'passport.private_key',
                secret: true,
            ),
            new EnvironmentVariableData(
                key: 'PASSPORT_PUBLIC_KEY',
                description: 'OAuth signing public key paired with PASSPORT_PRIVATE_KEY.',
                category: 'Partner API',
                configPath: 'passport.public_key',
                secret: true,
            ),
            new EnvironmentVariableData(
