...
it('documents cockpit wave 56b automated clipboard ux evidence guard', function () {
    ...
    $voucherDetailTestPath = $packageRoot.'/tests/frontend/cockpit/CockpitPayCodeShareCard.test.ts';
    ...
    expect($report)->toContain('Cockpit Wave 56B — Automated Clipboard UX Evidence Guard')
        ...
        ->and($voucherDetailTest)->toContain('copies only the canonical claim URL')
