...
it('emits bounded amount input for canonical flexible slice plans', function () {
    ...
    expect($formFlow['owner'])->toBe('claim-widget')
        ...
        ->and($amount['label'])->toBe('Amount to claim · Claim 1 of 4')
        ->and($amount['description'])->toContain('4 of 4 claims remaining')
        ->and($amount['description'])->toContain('Minimum ₱5.00 per claim')
