...
describe("Cockpit Voucher Detail foundation", () => {
  it("renders voucher overview facts from read-only defaults", () => {
    ...
    expect(
      wrapper
        .find('[data-testid="cockpit-voucher-overview-panel"]')
    ...
    expect(
      wrapper.findAll('[data-testid="cockpit-voucher-overview-item"]'),
    ).toHaveLength(6);
    expect(
      wrapper
        .findAll('[data-testid="cockpit-voucher-overview-item"]')[0]
        .classes(),
    ).toContain("p-3");
  });
  ...
  it("renders lifecycle timeline placeholders without invoking execution", () => {
    ...
    expect(
      wrapper
        .find('[data-testid="cockpit-voucher-timeline-panel"]')
        .element.tagName.toLowerCase(),
    ).toBe("details");
    expect(
      wrapper
    ...
    expect(
      wrapper.find('[data-testid="cockpit-voucher-timeline-panel"]').classes(),
    ).toContain("self-start");
    expect(wrapper.find("summary").text()).toContain("4 events");
    expect(
      wrapper.findAll('[data-testid="cockpit-voucher-timeline-item"]'),
    ).toHaveLength(4);
  });
  ...
  it("renders evidence and distribution placeholders from supplied read models", () => {
    ...
    expect(
      evidence
        .find('[data-testid="cockpit-voucher-evidence-panel"]')
        .element.tagName.toLowerCase(),
    ).toBe("details");
    expect(
      evidence
    ...
    expect(
      evidence
        .find('[data-testid="cockpit-voucher-evidence-density-summary"]')
        .text(),
    ).toContain("Evidence Facts");
    expect(
      evidence
        .find('[data-testid="cockpit-voucher-evidence-density-summary"]')
        .text(),
    ...
    expect(
      evidence.findAll('[data-testid="cockpit-voucher-evidence-item"]'),
    ).toHaveLength(3);
    ...
    expect(
      distribution
        .find('[data-testid="cockpit-voucher-distribution-panel"]')
        .element.tagName.toLowerCase(),
    ).toBe("details");
    expect(
      distribution
    ...
    expect(
      distribution
        .find('[data-testid="cockpit-voucher-distribution-density-summary"]')
        .text(),
    ).toContain("Channels");
    expect(
      distribution
    ...
    expect(
      distribution.findAll('[data-testid="cockpit-voucher-distribution-item"]'),
    ).toHaveLength(3);
    expect(
  ...
  it("renders audit placeholders and disabled actions without command behavior", () => {
    ...
    expect(
      wrapper
        .find('[data-testid="cockpit-voucher-audit-panel"]')
        .element.tagName.toLowerCase(),
    ).toBe("details");
    expect(
      wrapper
    ...
    expect(
      wrapper.find('[data-testid="cockpit-voucher-audit-panel"]').classes(),
    ).toContain("py-2.5");
    expect(
      wrapper.find('[data-testid="cockpit-voucher-audit-summary"]').classes(),
    ).toContain("sm:flex-row");
    expect(
      wrapper.find('[data-testid="cockpit-voucher-audit-summary"]').text(),
    ).not.toContain("View details");
    expect(
      wrapper
        .find('[data-testid="cockpit-voucher-audit-density-summary"]')
        .text(),
    ).toContain("evidence");
    expect(
      wrapper
    ...
    expect(
      wrapper.find('[data-testid="cockpit-voucher-audit-guidance"]').text(),
    ).toContain("does not execute actions");
    expect(
      wrapper
        .find('[data-testid="cockpit-voucher-disabled-actions-disclosure"]')
        .exists(),
    ).toBe(true);
    expect(
      wrapper.findAll('[data-testid="cockpit-voucher-audit-item"]'),
    ).toHaveLength(3);
  ...
  it("renders the full voucher detail page with active Pay Codes navigation and side-effect boundaries", () => {
    ...
    expect(wrapper.text()).toContain("Claim readiness");
    expect(wrapper.text()).toContain("Lifecycle");
    expect(wrapper.text()).toContain("Pay Codes");
  ...
  it("renders the voucher shell as a sleek operational header", () => {
    ...
    expect(
      facts.findAll('[data-testid="cockpit-voucher-detail-header-fact"]'),
    ).toHaveLength(3);
  ...
  it("renders safe campaign recipient context on voucher detail without mutation controls", () => {
    ...
    expect(
      ...
      "/x/cockpit/pay-codes?campaign_planning_key=plan-wave-46&campaign_execution_id=exec-wave-46&campaign_id=campaign-wave-46&campaign_audience_id=audience-wave-46&campaign_recipient_id=recipient-wave-46&campaign_source=x_campaign_adapter&activity_code=Not+wired&activity_source=operator_issuance_activity",
    );
    expect(
      wrapper
        .find(
    ...
    expect(
      ...
      "/x/cockpit?campaign_planning_key=plan-wave-46&campaign_execution_id=exec-wave-46&campaign_id=campaign-wave-46&campaign_audience_id=audience-wave-46&campaign_recipient_id=recipient-wave-46&campaign_source=x_campaign_adapter",
    );
    expect(
      wrapper
        .find(
        ...
        .text(),
    ).toContain("Back to Campaign Dashboard");
    expect(
      wrapper
        .find(
          '[data-testid="cockpit-voucher-detail-campaign-dashboard-return-link"]',
