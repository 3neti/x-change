            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        x-change blah, blah, blah. <br />We suggest starting with the following.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                Read the
                                <a
                                    href="https://netbank.cashless/docs"
                                    target="_blank"
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] dark:bg-[#1D0002] lg:-ml-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-r-lg lg:rounded-t-none flex items-center justify-center"
                >
                    <img src="/x-change.svg" alt="x-change logo" class="max-w-full max-h-full object-contain" />
